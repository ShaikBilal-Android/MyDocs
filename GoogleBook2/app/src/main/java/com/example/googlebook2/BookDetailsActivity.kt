package com.example.googlebook2
...
class BookDetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imgurl = i.volumeInfo?.imageLinks?.thumbnail
        Glide.with(this).load(imgurl).into(bookDetailsImage)

        Log.d("GlideImgUrl","Image URL.....:$imgurl")
...
//        log("GLIDE IMAGE URL....",i.toString())
    }
